...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	 ...
    	 // If the code is written by yourself or your teammates, it's always allowed
        if (writtenByYourself) {
            return true;
        }
        
        // If the code is not written by yourself, it must be available to others in the class,
        // not be written as course work, and properly cited.
        if (availableToOthers && !writtenAsCourseWork && citingYourSource) {
            // If the assignment does not specifically require you to implement the feature
            // yourself, you may use the code.
